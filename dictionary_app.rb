...
# use wordnik API to show the words definition
  ...
  top_example_data = HTTP.get("https://api.wordnik.com/v4/word.json/tree/topExample?useCanonical=false&api_key=")
  ...
  p how_to_pronounce
  audio = HTTP.get("https://api.wordnik.com/v4/word.json/#{word}/audio?useCanonical=false&limit=50&api_key=")
  audio_data = audio.parse
